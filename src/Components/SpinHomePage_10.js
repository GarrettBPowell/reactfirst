...
import './SpinHomePage_10.css'
import ImgAsset from '../public'
import NavigationBar from "./NavigationBar"
import Header2Default from "./Header2Default"
import SpinnerHeader from "./SpinnerHeader"
import EditButton from "./EditButton"
export default function SpinHomePage_10 () {
	return (
		<div className='SpinHomePage_10_SpinHomePage'>
					...
					<div className='Spinner_1'>
						<div className='Spinner_2'>
							<div className='SpinWheelBackground'>
								<img className='Polygon1' src = {ImgAsset.SpinHomePage_10_Polygon1} />
								<img className='Polygon2' src = {ImgAsset.SpinHomePage_10_Polygon2} />
								<img className='Polygon3' src = {ImgAsset.SpinHomePage_10_Polygon3} />
								<img className='Polygon4' src = {ImgAsset.SpinHomePage_10_Polygon4} />
								<img className='Polygon5' src = {ImgAsset.SpinHomePage_10_Polygon5} />
								<img className='Polygon6' src = {ImgAsset.SpinHomePage_10_Polygon6} />
								<img className='spinnerdivision' src = {ImgAsset.SpinHomePage_10_spinnerdivision} />
