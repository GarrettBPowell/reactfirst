...
import './SpinHomePage_13.css'
import ImgAsset from '../public'
import NavigationBar from "./NavigationBar"
import Header2Default from "./Header2Default"
import SpinnerHeader from "./SpinnerHeader"
import EditButton from "./EditButton"
export default function SpinHomePage_13 () {
	return (
		<div className='SpinHomePage_13_SpinHomePage'>
					...
					<div className='Spinner_1'>
						<div className='Spinner_2'>
							<div className='SpinWheelBackground'>
								<img className='Polygon1' src = {ImgAsset.SpinHomePage_13_Polygon1} />
								<img className='Polygon2' src = {ImgAsset.SpinHomePage_13_Polygon2} />
								<img className='Polygon3' src = {ImgAsset.SpinHomePage_13_Polygon3} />
								<img className='Polygon4' src = {ImgAsset.SpinHomePage_13_Polygon4} />
								<img className='Polygon5' src = {ImgAsset.SpinHomePage_13_Polygon5} />
								<img className='Polygon6' src = {ImgAsset.SpinHomePage_13_Polygon6} />
								<img className='spinnerdivision' src = {ImgAsset.SpinHomePage_13_spinnerdivision} />
