...
import styles from "./ResturantsAdd7.module.css";

const ResturantsAdd7: FunctionComponent = () => {
  const navigate = useNavigate();

  const onRemoveButtonIcon6Click = useCallback(() => {
    navigate("/resturants-add-8");
  }, [navigate]);

  return (
    <div className={styles.resturantsAdd7}>
