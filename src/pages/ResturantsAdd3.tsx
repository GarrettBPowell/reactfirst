...
import styles from "./ResturantsAdd3.module.css";
const ResturantsAdd3: FunctionComponent = () => {
  const navigate = useNavigate();

  const onAddItemContainerClick = useCallback(() => {
    navigate("/resturants-add-4");
  }, [navigate]);

  return (
    <div className={styles.resturantsAdd3}>
