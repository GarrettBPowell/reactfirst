...
import styles from "./ResturantsAdd5.module.css";

const ResturantsAdd5: FunctionComponent = () => {
  const navigate = useNavigate();

  const onAddItemContainerClick = useCallback(() => {
    navigate("/resturants-add-6");
  }, [navigate]);

  return (
    <div className={styles.resturantsAdd5}>
