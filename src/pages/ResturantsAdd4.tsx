...
import styles from "./ResturantsAdd4.module.css";
const ResturantsAdd4: FunctionComponent = () => {
  const navigate = useNavigate();

  const onAddItemContainerClick = useCallback(() => {
    navigate("/resturants-add-5");
  }, [navigate]);

  return (
    <div className={styles.resturantsAdd4}>
