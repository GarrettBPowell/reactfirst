...
import styles from "./ResturantsAdd6.module.css";
const ResturantsAdd6: FunctionComponent = () => {
  const navigate = useNavigate();

  const onAddItemContainer4Click = useCallback(() => {
    navigate("/resturants-add-7");
  }, [navigate]);

  return (
    <div className={styles.resturantsAdd6}>
            ...
            <div className={styles.sectionAdder}>
              ...
              <div className={styles.removeMenu}>
                ...
                <div className={styles.frameParent}>
                  ...
                  <div className={styles.addItemGroup}>
                    <div
                      className={styles.addItem4}
                      onClick={onAddItemContainer4Click}
                    >
                      <div className={styles.selectionAdderButton}>
                        <div className={styles.button1}>
                          <img
