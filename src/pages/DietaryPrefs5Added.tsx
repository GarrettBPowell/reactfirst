...
import styles from "./DietaryPrefs5Added.module.css";
const DietaryPrefs5Added: FunctionComponent = () => {
  const navigate = useNavigate();

  const onRemoveButtonIcon4Click = useCallback(() => {
    navigate("/dietary-prefs-1-removed");
  }, [navigate]);

  return (
    <div className={styles.dietaryPrefs5Added}>
          ...
          <div className={styles.searchBarParent}>
            ...
            <div className={styles.sectionAdder}>
              <div className={styles.removeMenu}>
                ...
                <div className={styles.removeButtonRow}>
                  <div className={styles.removeItem}>
                    <div className={styles.removeText}>Sesame</div>
                    <img
                      className={styles.removeButtonIcon4}
                      alt=""
                      src="/remove-button5.svg"
                      onClick={onRemoveButtonIcon4Click}
                    />
                  </div>
...
export default DietaryPrefs5Added;
