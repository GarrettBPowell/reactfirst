...
import styles from "./AddFriends2.module.css";
const AddFriends2: FunctionComponent = () => {
  const navigate = useNavigate();

  const onAddItemContainerClick = useCallback(() => {
    navigate("/add-friends1");
  }, [navigate]);
                      ...
                      <div className={styles.selectionAdderButton}>
                        <div className={styles.button1}>
                          <img
                            ...
                            src="/vector.svg"
                          />
                          <div className={styles.buttonText}>Stacy</div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className={styles.selectionAdderButton}>
                        <div className={styles.button1}>
                          <img
                            ...
                            src="/vector.svg"
                          />
                          <div className={styles.buttonText}>John</div>
                        </div>
                      </div>
                    </div>
                  </div>
